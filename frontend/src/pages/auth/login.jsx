...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Use centralized utility to manage session
      login(response.data);
      ...
      // Check if the error is specifically for password expiration
      console.log("Login error:", err.response?.data);
      if (err.response?.data?.error === "PASSWORD_EXPIRED") {
        // Store temporary data for password change page
        // We store the credentials temporarily so the user doesn't have to re-enter them
        sessionStorage.setItem('expiredPasswordUser', JSON.stringify({
          usernameOrEmail,
          password,
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="username"
                  placeholder="username ou user@example.com"
